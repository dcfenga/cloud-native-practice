...
Go 协程相比于线程的优势:
 1. 相比线程而言，Go 协程的成本极低。堆栈大小只有若干 kb，并且可以根据应用的需求进行增减。
...
func main() {
	...
	// 输出：main function，hellogoroutine无时间运行
	// 分析：
	...
	fmt.Println("main function2")
	fmt.Println("=============")

	// 启动2个 Go 协程,这两个协程并发地运行
	// 运行示例见multi_goroutine_example.png
