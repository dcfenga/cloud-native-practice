...
import (
	...
	versioned "dcfenga/cloud-native-practice/crd-custom-vmcontroller/pkg/client/clientset/versioned"
	internalinterfaces "dcfenga/cloud-native-practice/crd-custom-vmcontroller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "dcfenga/cloud-native-practice/crd-custom-vmcontroller/pkg/client/listers/vmcontroller/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.VmcontrollerV1().VirtualMachines(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VmcontrollerV1().VirtualMachines(namespace).Watch(context.TODO(), options)
			},
		},
		&vmcontrollerv1.VirtualMachine{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *virtualMachineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vmcontrollerv1.VirtualMachine{}, f.defaultInformer)
}
