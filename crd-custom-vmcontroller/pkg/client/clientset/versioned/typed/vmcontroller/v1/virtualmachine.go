...
import (
	...
	scheme "dcfenga/cloud-native-practice/crd-custom-vmcontroller/pkg/client/clientset/versioned/scheme"
	"time"
...
func newVirtualMachines(c *VmcontrollerV1Client, namespace string) *virtualMachines {
